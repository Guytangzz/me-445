...
sx = -0.0231;                 % displacement of circle center in  real axis. // velocity potential
sy = -0.02    ;                 % displacement of circle center in  imaginary axis.  // stream function
s = sx + i*sy;              % resultant displacement in the z plane 
r = 0.3106;                   % radius of the cylinder in complex z plane (x+iy)    
